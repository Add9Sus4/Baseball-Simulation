...
class AttributeAdjustments
  ...
  BATTER_PLATE_VISION_AFFECTS_SWING_PERCENTAGE_MIN = 0.8
  ...
  BATTER_PATIENCE_AFFECTS_SWING_PERCENTAGE_MAX = 0.25
  ...
  BATTER_BATTING_AVERAGE_AFFECTS_LINE_DRIVE_PROBABILITY_MIN = 0.25
  BATTER_BATTING_AVERAGE_AFFECTS_LINE_DRIVE_PROBABILITY_MAX = 0.5

  #################### PERCENT_POP_UP ####################

  # Batter batting average attribute
  BATTER_BATTING_AVERAGE_AFFECTS_POP_UP_PROBABILITY_MIN = 0.05
  BATTER_BATTING_AVERAGE_AFFECTS_POP_UP_PROBABILITY_MAX = 0.20
  ...
  # Batter batting average attribute
  BATTER_BATTING_AVERAGE_AFFECTS_FIELD_PROBABILITY_MIN = 0.8
  BATTER_BATTING_AVERAGE_AFFECTS_FIELD_PROBABILITY_MAX = 1.25
